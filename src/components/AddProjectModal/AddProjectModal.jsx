...
const AddProjectModal = ({users, setUsers, setOpenModal}) => {
   ...
   return (
     <div
       className="fixed justify-center flex w-full min-h-screen bg-white p-6 top-0 right-0 left-0 bottom-0 m-0-auto overflow-x-scroll z-50">
        <form onSubmit={formik.handleSubmit} className="">
           ...
           <div className="p-16 rounded-lg shadow-inner bg-slate-300">
              <div className="mb-6">
                 <label htmlFor="title" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600">Название
                    Проекта</label>
                 <input type="text"
                        id="title"
                        name="title"
              ...
              <div className="grid gap-6 mb-6 lg:grid-cols-2">
                 <div>
                    <label htmlFor="manager"
                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600">Руководитель
                       проекта</label>
                    <input type="text"
                           id="manager"
                           name="manager"
                 ...
                 <div>
                    <label htmlFor="administrator"
                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600">Администратор
                       проекта</label>
                    <input type="text"
                           id="administrator"
                           name="administrator"
                    ...
                    {formik.errors.administrator ?
                      <div className="text-red-400 text-sm">{formik.errors.administrator}</div> : null}
                 </div>
                 <div>
                    <label htmlFor="dateStart"
                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600">Дата
                       старта</label>
                    <input type="date"
                           id="dateStart"
                           name="dateStart"
                    ...
                    {formik.errors.dateStart ?
                      <div className="text-red-400 text-sm">{formik.errors.dateStart}</div> : null}
                 </div>
                 <div>
                    <label htmlFor="date"
                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600">Дата
              ...
              <div className="mb-6">
                 <label htmlFor="image" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600">Ссылка
                    на изображение</label>
                 <input type="text"
                        id="image"
                        name="image"
                        onChange={formik.handleChange}
