        ...
        <Layout>
           ...
           <div className="flex justify-between mb-3">
              ...
              <button onClick={() => setOpenModal(true)}
                      className="p-2 bg-fuchsia-500 hover:bg-fuchsia-600 hover:text-white">Добавить проект
              </button>
           </div>
           <div className="text-end text-xl">
              <button onClick={() => handleChangeBox()}
                      className="text-gray-500 hover:text-violet-500 active:bg-gray-500 mr-2"><FontAwesomeIcon
                   ...
                   <div key={user.id} className="flex lg:w-1/3 md:w-1/2 sm:w-full p-3 box-border shadow-2xl">
                      <div>
                         ...
                         <div className="flex mb-1">
                            <span className="text-xs ml-1 font-medium text-gray-600"><FontAwesomeIcon
                              icon={faCalendar}/></span>
                            <h2
                              className="text-xs ml-1 font-medium text-gray-600">{`${user.dateStart.split("-").reverse().join(".")} - `}</h2>
                            <h2
                              className="text-xs ml-1 font-medium text-gray-600">{`${user.dateEnd.split("-").reverse().join(".")} гг.`}</h2>
                         </div>
                         <div className="flex mb-1">
                            <span className="text-xs ml-1 font-medium text-gray-600"><FontAwesomeIcon
                              icon={faUser}/></span>
