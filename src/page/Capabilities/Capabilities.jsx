...
const Capabilities = () => {
   return (
     <Layout>
        <h2 className="uppercase text-2xl text-purple-900 font-medium pt-4 pb-4">Возможности</h2>
        <div className="flex">
           <h5
        ...
        <div className="flex justify-between mb-3">
           <h2 className="uppercase items-end font-medium text-gray-500">список Возможности</h2>
